...
Item {
  ...
  Dialog { id: diagnostics; modal: true; title: "Rayarchy diagnostics"; standardButtons: Dialog.Close; contentItem: TextArea { id: diagnosticsText; width: 520; height: 300; readOnly: true; wrapMode: TextEdit.Wrap; selectByMouse: true } }
