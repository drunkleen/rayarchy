      ...
      delegate: Rectangle {
        ...
        Dialog {
          ...
          contentItem: Column {
            ...
            Button { text: "Quick edit fields"; onClicked: { protocolEditorLoader.item.load(modelData); protocolEditorLoader.item.open() } }
